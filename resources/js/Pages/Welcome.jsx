                    ...
                    <div>
                        <div className="container flex flex-col flex-wrap items-center justify-between px-3 mx-auto md:flex-row">
                            <div className="flex flex-col items-start justify-center w-full pt-24 text-center md:w-2/5 md:text-left">
                                ...
                                <a href="{{ asset('images/brosur.pdf') }}" className="px-8 py-4 mx-auto my-6 font-bold text-gray-800 transition duration-300 ease-in-out transform bg-white rounded-full shadow-lg cursor-pointer lg:mx-0 focus:outline-none focus:shadow-outline hover:scale-105" download="brosur-smp-al-musyaffa">
                                    Download
                                </a>
                            </div>
